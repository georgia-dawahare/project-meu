...
import {
  Text, Button, SafeAreaView, StyleSheet, View, Image, Dimensions, Modal, Platform,
} from 'react-native';
...
function PenguinsPage() {
  ...
  return (
    <SafeAreaView style={[styles.container, { paddingTop: screenHeight * 0.06974, paddingHorizontal: screenWidth * 0.0465 }]}>
      ...
      <View style={[styles.carouselContainer, { marginTop: screenHeight * 0.02, marginBottom: screenHeight * 0.0644, marginLeft: (-screenWidth / 100) * 5.4 }]}>
        <View
          style={[styles.circle, {
            borderRadius: screenHeight * 0.1395,
            borderWidth: screenWidth * 0.0186,
            transform: [{ translateX: -screenWidth * 0.0610 }, { translateY: -screenHeight * 0.057 }],
          }]}
        />
